...
- The `DFworkshop.csv` dataset used in this presentation is available at: http://tinyurl.com/DFwsData
    - [DOWNLOAD]

- For later reference, this presentation is available at: http://tinyurl.com/DFwsPres

- The **script** containing all the `R` commands is available at: http://tinyurl.com/DFwsScript
